...
Next we try our own implementation of the infinitesimal jackknife (we don't have some extras implemented by the authors of the randomForestCI package, such as calibration, but this is nice as a comparison). To compute the infinitesimal jackknife variance, we need sampling with replacement. 
```{r}
