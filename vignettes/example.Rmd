...
We can also estimate the variance of the train set predicted probabilities. Note: there is a bug here because probability > 1, need to look closer at the splitting.
```{r}
